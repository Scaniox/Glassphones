...
typedef enum _MSPK_CFG_Key_IdDefinition_T
{
    ...
    MSPK_CFG_KEY_CSB_TRIGGER_SYNC_ROLE_SETTING  = 0x0B, /**<\#PARAM_NAME :  MSPK_CFG_KEY_CSB_TRIGGER_SYNC_ROLE_SETTING\n
                                                    	    ...
                                                    	    \#BIT_POS : 0 \n
                                                    	    \#BIT_SIZE : 1 \n
                                                    	    \#BIT_DESC : Predefine MSPK role as master role. This is used when the option ENABLE_MSPK_ROLE_BY_CONFIG_SETTING is enabled. \n
                                                    	    ...
                                                    	    \#BIT_POS : 1 \n
                                                    	    \#BIT_SIZE : 1 \n
                                                    	    \#BIT_DESC : Predefine MSPK role as slave role. This is used when the option ENABLE_MSPK_ROLE_BY_CONFIG_SETTING is enabled. \n
                                                    	    \#DESC_END
                                                    	    ...
                                                    	    \#BIT_POS : 3 \n
                                                    	    \#BIT_SIZE : 1 \n
                                                    	    \#BIT_DESC : MSPK role is stored as master when the speaker as master powered off in MSPK connected state. \n
                                                    	    \#DESC_END
                                                    	    ...
                                                    	    \#BIT_POS : 4 \n
                                                    	    \#BIT_SIZE : 1 \n
                                                    	    \#BIT_DESC : MSPK role is stored as slave when the speaker as slave powered off in MSPK connected state. \n
                                                    	    \#DESC_END
                                                	    */
    ...
    MSPK_CFG_KEY_OPTION1                        = 0x0C, /**<\#PARAM_NAME :  MSPK_CFG_KEY_OPTION1\n
                                                    	    ...
                                                    	    \#BIT_POS : 0 \n
                                                    	    \#BIT_SIZE : 1 \n
                                                    	    \#BIT_DESC : If this option is enabled (set to 1), the speaker will try to recover the CSB link when the CSB link disconnects abnormally. Only for Stereo mode.\n
                                                    	    \#DESC_END
    ...
    MSPK_CFG_KEY_OPTION2                        = 0x0D, /**<\#PARAM_NAME :  MSPK_CFG_KEY_OPTION2\n
                                                            ...
                                                            \#BIT_POS : 5 \n
                                                            \#BIT_SIZE : 1 \n
                                                            \#BIT_DESC : Enable seamless audio resync that can keep audio sync in CSB master and other slaves with audio breaks when a new slave is added. \n
                                                            \#DESC_END
