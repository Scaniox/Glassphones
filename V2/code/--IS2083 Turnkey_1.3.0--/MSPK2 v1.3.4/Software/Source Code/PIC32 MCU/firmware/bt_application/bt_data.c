...
#define BLE_CONN_MIN_INT	0x48
#define BLE_CONN_MAX_INT	0x50
#define BLE_CONN_LATENCY	0x00
#define BLE_CONN_SUP		0xC8
/*-----------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------*/
...
//                            }
                    ...
                    case BLE_CONN_CONNECTED: //connected
                        ...
                        if(BLE_LinkStatus.BLE_GATTServiceStatus.bits.transparentServiceActive)
                        {
                            ...
                            BLE_SetConnParam(BLE_CONN_MIN_INT, BLE_CONN_MAX_INT, BLE_CONN_LATENCY, BLE_CONN_SUP);
